...
<div class="box-header with-border">
    ...
    <div class="box-header with-border">
        ...
        <div class="box-tools">
            ...
            <?php if($this->auth->can('add_patient')): ?>
            <button class="btn btn-success btn-sm" onclick="add_patient()"><i class="glyphicon glyphicon-plus"></i> Add
                Client</button>
            <?php else : ?>
  ...
  <table id="patient_table" class="table table-striped table-bordered nowrap" style="width:100%">
        <thead>
            <tr>
    ...
    function save() {
        ...
        if (save_method == 'add') {
            url = "<?php echo site_url('PatientController/addPatient')?>";
        } else {
                ...
                <div class="modal-body form">
                    <form action="#" id="form" class="form-horizontal">
                            ...
                            <div class="row">
                                <fieldset>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Age/Date of Birth</label>
                                            <div class="col-md-8">
                                                <input type="text" id="age" class="form-control col-3" oninput="getBirthdate()" placeholder="Age in year">
						<input name="birth_date" id="birth_date" data-date-format="yyyy-mm-dd"
                                                    placeholder="yyyy-mm-dd" class="form-control datepicker col-9"
                                                    type="text" onChange="getAge()">
						...
						<select name="nationality" class="form-control" required>
                                                    <?php foreach ($countrys->result() as $row) :?>
                                                    <option value="<?php echo $row->iso;?>" <?php if($row->name == "ETHIOPIA") echo 'selected';?> >
                                                        <?php echo $row->name;?>
                                                    </option>
                                                    <?php endforeach;?>
                                                </select>
                            ...
                            <div class="row">
                                <fieldset>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Requesting Physician Name</label>
                                            <div class="col-md-8">
                                                <input name="physician_name" placeholder="Physician Name" class="form-control"
                                                    type="text">
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
