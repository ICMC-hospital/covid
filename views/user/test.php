            ...
            <div class="col-lg-12">
              <div class="tabbable tabs-left">
                <ul id="myTab4" class="nav nav-tabs col-md-3">
                  <li class="active">
                    <a href="#tab_Permission" data-toggle="tab">
                  ...
                  <li id="permis">
                    <a href="#rolepermissionSetting" data-toggle="tab">
                ...
                <div class="tab-content col-md-9">
                  <div class="tab-pane fade in" id="templates-div"></div>
                    <div class="tab-pane fade active in" id="tab_Permission">
                      <div class="row">
                      ...
                      <form method="post" enctype="multipart/form-data" action="<?php echo base_url().'setting/edit_setting' ?>" data-parsley-validate class="form-horizontal form-label-left demo-form2">
                        ...
                        <div class="tab-pane " id="rolepermissionSetting">
                          <div class="row">
                            <div class="box-header my-header">
...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        $('#addmoreRolesShow').hide();
        location.reload();
        //window.location.href="<?php //echo base_url().'setting#rolepermissionSetting'; ?>";
        /*setTimeout(function(){ 
