...
class Auth
{
    ...
    protected function init()
    {
        if ($this->CI->session->has_userdata("userID") && $this->CI->session->loginStatus) {
            ...
            $this->member_of = $this->CI->session->member_of;
    ...
    public function route_access()
    {
        ...
        if ($this->CI->uri->segment(1) == 'PatientController'||'SampleController'||'LabController' || 'UserController' || 'DashBoardController')
            return true;
